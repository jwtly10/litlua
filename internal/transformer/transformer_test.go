	...
	tests := []struct {
		...
		},
		{
			...
			validate: func(t *testing.T, outputPath string) {
				...
				require.Contains(t, outputPath, "basic.md.lua")
		...
		},
		{
			...
			inputFile: "with_invalid_output_pragma.md",
			opts: TransformOptions{
				WriterMode:          litlua.ModePretty,
				NoBackup:            true,
				RequirePragmaOutput: true,
			...
			validate: func(t *testing.T, outputPath string) {
				...
				require.Contains(t, outputPath, "compiled.invalid.lua")
		...
		},
		{
			...
			validate: func(t *testing.T, outputPath string) {
				...
				require.Contains(t, outputPath, "with_invalid_output_pragma.md.lua")
